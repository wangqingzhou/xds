  ...
  <div class="app-container">
    ...
    <el-card shadow="hover" class="data-table">
      ...
      >
        ...
        <el-table-column prop="code" label="栏目编号" width="200" />
        <el-table-column prop="id" label="栏目ID" width="200" />
    ...
    >
      <el-form ref="deptFormRef" :model="formData" :rules="rules" label-width="80px">
        ...
        <el-form-item label="栏目编号" prop="code">
          <el-input v-model="formData.code" placeholder="请输入栏目编号" />
        </el-form-item>
...
import DeptAPI, { DeptVO, DeptForm, DeptQuery } from "@/api/system/class.api";
...
const rules = reactive({
  ...
  code: [{ required: true, message: "栏目编号不能为空", trigger: "blur" }],
