          ...
          >
              ...
              <div class="score-display">
                ...
                <el-form-item label="学院审核分" prop="collegeScoreAcademic">
                  <el-input-number
                    ...
                    @change="updateScoreTable"
                  />
                  <span class="readonly-hint">学院审核后显示</span>
                </el-form-item>
              </div>
            ...
            <div class="form-section">
              ...
              <el-form-item label="声明确认" prop="overallValid">
                ...
                <el-radio-group v-model="formData.overallValid">
                  <el-radio value="yes">
            ...
            <div class="form-actions">
              <el-button type="primary" class="action-btn" @click="handleSubmit">
                <el-icon><Upload /></el-icon>
                提交审核
              </el-button>
              <el-button class="action-btn" @click="handleClose">
...
onMounted(() => {
  ...
  if (id && typeof id === "string") {
    MaterialAPI.getDetail(id).then((data) => {
      ...
      console.log("身份证件相关字段:", {
        idCardFileUrls: data.idCardFileUrls,
        idCardFileUrlsArray: data.idCardFileUrlsArray,
        type: typeof data.idCardFileUrls,
      });
      console.log("其他材料相关字段:", {
        otherFileUrls: data.otherFileUrls,
        otherFileUrlsArray: data.otherFileUrlsArray,
        type: typeof data.otherFileUrls,
      });
      ...
      console.log("=== 解析后的数据 ===");
      console.log("身份证件文件URLs:", formData.idCardFileUrls);
      console.log("其他材料文件URLs:", formData.otherFileUrls);
      ...
      const arrayFields = [
        ...
        "volunteerFileUrls",
        "competitionFileUrls",
        "idCardFileUrls", // 确保包含身份证件字段
        "otherFileUrls", // 确保包含其他材料字段
      ];
